...
--
-- Name: user_trials; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: user_trials_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: user_trials user_trials_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_trials Users manage own trial; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users manage own trial" ON public.user_trials USING (((auth.uid())::text = user_id)) WITH CHECK (((auth.uid())::text = user_id));


--
-- Name: user_trials; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE user_trials; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE user_trials_id_seq; Type: ACL; Schema: public; Owner: postgres
--
